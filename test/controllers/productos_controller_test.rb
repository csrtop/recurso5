...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { club_id: @producto.club_id, descripcion: @producto.descripcion, item: @producto.item, pasillo: @producto.pasillo } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { club_id: @producto.club_id, descripcion: @producto.descripcion, item: @producto.item, pasillo: @producto.pasillo } }
