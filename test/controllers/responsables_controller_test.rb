...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post responsables_url, params: { responsable: { club_id: @responsable.club_id, responsable: @responsable.responsable } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { club_id: @responsable.club_id, responsable: @responsable.responsable } }
